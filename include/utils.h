...
typedef struct trace_entry {
    struct {
       uint64_t op:8;		/* operation type */
       uint64_t tag:56;		/* arbitrary identifying tag */
    } info;
