...
motif_1: $(MOTIF_1_OBJS) $(PRNG_OBJS) $(SAMPLE_OBJS) $(LOG_OBJS)
	$(CC) $(CFLAGS) $(LDFLAGS) -o $@ $(MOTIF_1_OBJS) $(PRNG_OBJS) $(SAMPLE_OBJS) $(LOG_OBJS) $(LIBS)

.PHONY: clean

clean: 
	$(RM) motif_1 $(MOTIF_1_OBJS) $(PRNG_OBJS) $(LOG_OBJS)
